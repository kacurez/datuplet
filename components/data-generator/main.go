...
func main() {
	...
	// glance that the running data-generator binary has the SDK
	// behavior they expect (e.g., Write() batching from v0.2.4+).
	// This is the single most valuable line for "did the image get
	// rebuilt against the new SDK?" diagnostics.
