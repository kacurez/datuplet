...
// Integration test (build tag `integration`) imports root-module packages
// (pkg/catalogwriter, pkg/datupleticeio) to seed an iceberg table via the
// repo's own write stack. Mirrors components/sql-transform/go.mod.
