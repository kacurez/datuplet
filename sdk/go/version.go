...
// for verifying that image rebuilds picked up new SDK behavior (e.g.,
// the v0.2.4 Write() batching).
func Version() string {
...
// Info is a snapshot of SDK build + default behavior. Components log
// this once at startup to make a run's environment debuggable from
// pod logs alone.
type Info struct {
