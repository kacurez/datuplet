...
// (DATUPLET_GATEWAY_DEBUG) gates both packages so operators flip ONE
// flag at boot. Kept in a separate file (not imported from the parent
// package) because the parent already imports buffer; the reverse would
// be cyclic.
